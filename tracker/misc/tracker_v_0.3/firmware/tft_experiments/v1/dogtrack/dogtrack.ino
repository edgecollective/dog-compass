...
void setup(void) {
  ...
  //stat = reader.drawBMP("/pond1.bmp", tft, 0, 0);
...
for (int x=50; x<100; x+=2) {
  ...
  //tft.fillScreen(0);
  reader.drawBMP("/pond1.bmp", tft, 0, 0);

  //user
  tft.drawCircle(128/2+128/4, 160/2+160/4, 5, YELLOW);
    tft.drawCircle(128/2+128/4, 160/2+160/4, 6, YELLOW);

  //doggie
  tft.drawCircle(x, 40, 5, RED);
  tft.drawCircle(x, 40, 6, RED);
  delay(1000);
}
  /*
