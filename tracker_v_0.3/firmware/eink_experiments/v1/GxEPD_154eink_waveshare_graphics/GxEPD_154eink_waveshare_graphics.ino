...
GxIO_Class io(SPI, /*CS=*/ 12, /*DC=*/ 11, /*RST=*/ 10); // arbitrary selection of 8, 9 selected for default of GxEPD_Class
GxEPD_Class display(io, /*RST=*/ 10, /*BUSY=*/ 9); // default selection of (9), 7
...
void loop()
{
  ...
  display.drawCircle(128/2+128/4, 160/2+160/4, 5, GxEPD_BLACK);
