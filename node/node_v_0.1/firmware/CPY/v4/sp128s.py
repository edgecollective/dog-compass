...
WIDTH = 128
HEIGHT = 128  # Change to 64 if needed
BORDER = 1
...
sparkline1 = Sparkline(width=chart_width, height=chart_height, max_items=40, y_min=0, y_max=1000, x=35, y=15, color=line_color)
